...
def main():
    ...
    parser.add_argument("--input_folder", type=str, default="data/raw/04_verified_sapis/01_seqs_with_host/individual_seqs/")
    parser.add_argument("--output_folder", type=str, default="data/visualization/validated_data/satellite_finder")
