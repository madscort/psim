...
if __name__ == "__main__":
    ...
    models = {
        'Pfam': 'data/visualization/performance/v02/pfama_single_v02_small_performance.tsv',
        'Aligned': 'data/visualization/performance/v02/mmdb_single_v02_small_performance.tsv',
        'AllDB': 'data/visualization/performance/v02/alldb_single_v02_small_performance.tsv',
        'AllDB_less': 'data/visualization/performance/v02/alldb_single_v02_small_less_vjiyv06a_performance.tsv'
    }
